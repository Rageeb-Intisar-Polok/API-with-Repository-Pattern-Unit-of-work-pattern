...
namespace DatabaseHandler.Controllers.Initialization
{
    ...
    public class InitializationController : BaseController
    {
        ...
        [HttpPost]
        public async Task<IActionResult> initialConfiguration([FromBody] InitializationDetailsModel model)
        {
            try
            {
                _model = model;
                ...
                await _workFlow._departmentHandlingRepository.AddSome(depts);
                ...
                await _workFlow._levelTermRepository.AddSome(levelTerms);
                ...
                await _workFlow._roleRepository.AddSome(roles);

                await _workFlow.Complete();
