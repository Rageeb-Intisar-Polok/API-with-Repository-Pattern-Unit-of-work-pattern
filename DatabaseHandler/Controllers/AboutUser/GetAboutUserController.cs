        ...
        public async Task<IActionResult> AboutUser(string id)
        {
            ...
            {                
                ...
                if (type == "teacher")
                {
                    ...
                    _visibleTeacher = await _getInfoAboutTeacherWork.getVisibleTeacher(individualId);
                ...
                else if(type == "student")
                {
                    ...
                    int individualId = user.IndividualID;
                    _visibleStudent = await _getInfoAboutStudentWork.getVisibleStudent(individualId);
                ...
                else if(type == "official")
                {
                    ...
                    int individualId = user.IndividualID;
                    _visibleOfficial = await _getInfoAboutOfficialWork.getVisibleOfficial(individualId);
